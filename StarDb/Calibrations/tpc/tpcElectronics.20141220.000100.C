...
// -----------------------------------------------------------------
// bfc/.make/db/.const/StarDb/Calibrations/tpc/.tpcElectronics/tpcElectronics Allocated rows: 1  Used rows: 1  Row size: 68 bytes
//  Table: tpcElectronics_st[0]--> tpcElectronics_st[0]
// ====================================================================
...
memset(&row,0,tableSet->GetRowSize());
    ...
    row.samplingFrequency	 =    9.38315; // MHz, not used,  overwritten by starClockOnl;
