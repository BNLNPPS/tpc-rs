...
// -----------------------------------------------------------------
// bfc/.make/db/.const/StarDb/Calibrations/tpc/.tpcOmegaTau/tpcOmegaTau Allocated rows: 1  Used rows: 1  Row size: 12 bytes
...
memset(&row,0,tableSet->GetRowSize());
    ...
    row.distortionCorrectionsMode	 =         0x1; // modes for field distortion and non-uniformity corrections  ;
tableSet->AddAt(&row);
// ----------------- end of code ---------------
