...
// -----------------------------------------------------------------
// bfc/.make/db/.const/StarDb/Calibrations/tpc/.tpcGridLeak/tpcGridLeak Allocated rows: 1  Used rows: 1  Row size: 72 bytes
//  Table: tpcGridLeak_st[0]--> tpcGridLeak_st[0]
// ====================================================================
// ------  Test whether this table share library was loaded ------
  if (!TClass::GetClass("St_tpcGridLeak")) return 0;
tpcGridLeak_st row;
