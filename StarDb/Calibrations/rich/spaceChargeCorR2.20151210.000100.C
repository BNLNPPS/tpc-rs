...
memset(&row,0,tableSet->GetRowSize());
    row.fullFieldB	 =  4.091e-08; // Negative Full Field Correction  ;
    ...
    row.detector	 =          3; // 0=VPDx, 1=BBCx, 2=ZDCx, 3=ZDCe+w, 4=BBCe+w, ... ;
    row.offset	 =      16320; // Offset at zero luminosity ;
